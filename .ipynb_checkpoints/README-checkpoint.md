...
## Field Neurons 
Field neurons are placed randomly around the field, and their function is to alter and transfer signals. They read their neighbors' values, run those values through a tiny random DNN (by default), and use the output to set their own axon value.<img src="images/field_neurons.png" style = "float: right;" width = 200>
